---
title: Blender - Windows on Arm
name: Blender
logo: /assets/images/content/windows_on_arm/Blender.png
description: Blender - Windows on Arm
image: /assets/images/content/iStock-667012914_sm.jpg
jumbotron:
  class: header_2021_2 theme_banner
  title_row: true
  title: Windows on Arm Project - Blender
  image: /assets/images/content/iStock-667012914_sm.jpg
links:
  - text: Enablement Notes
    url: https://linaro.atlassian.net/wiki/spaces/WOAR/pages/28769779775/Blender
flow:
  - row: container_row
    style: #
    sections:
...
Blender support for Windows on Arm is in progress, with development and enablement of features ongoing.

Currently the "lite" version is functional on the ARM64 architecture.

Please see enablement notes for more details on our fork, and building instructions.
