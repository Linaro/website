...
const postFields = [
  ...
  },
  {
    ...
    name: "description",
    widget: "text",
    hint: "The description of your blog post. Used in the meta:description field for SEO",
  },
  {
    label: "Publish Date",
    name: "date",
    ...
    pickerUtc: false,
    hint: "Please note that these dates are in your local time. Your changes need to be published after the date/time above in order for your changes to appear on the website.",
  },
  {
    label: "Image",
    name: "image",
  ...
  {
    label: "Strap Header Image",
    name: "strap_image",
    widget: "image",
    hint: "The strap image is used for the 'strap' header at the top of a post",
    required: false,
  },
  {
    label: "Tags",
  ...
  },
  {
    ...
    file: "projects",
    searchFields: ["projects.*.key"],
    display_fields: ["projects.*.key"],
    valueField: "projects.*.key",
    multiple: true,
    required: false,
    hint: "Tag a single related project",
  },
  {
    label: "Category",
    name: "category",
            ...
            },
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  name: "style",
                  widget: "text",
                  hint: "List of css classes for your section.",
                  required: false,
                },
                {
                  label: "Text",
...
const header = {
  ...
  fields: [
    ...
    },
    {
      label: "SVG",
      name: "svg",
      hint: "The name of a Jekyll HTML include containing the SVG.",
      required: false,
      widget: "string",
    },
    {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          widget: "string",
          required: false,
          hint: "The url your button will link to.",
        },
        {
          label: "Button Class",
          name: "class",
          widget: "string",
          required: false,
          hint: "Add an additional class to your button for custom styling.",
        },
        {
          label: "Button Icon",
          name: "icon",
          widget: "string",
          required: false,
          hint: "Optionally add a font awesome icon to your button. Required format - 'fa fa-download' visit https://fontawesome.com/v4.7.0/icons/ for a full list of icons available.",
        },
      ],
    },
    {
  ...
  collections: [
              ...
              fields: [
                {
                  ...
                  name: "subejct",
                  widget: "string",
                  hint: "The subject text (text in white)",
                  required: true,
                },
                {
                  label: "Link Text",
                ...
                },
                {
                  ...
                  name: "link",
                  widget: "string",
                  hint: "The URL you want this link to go to.",
                  required: true,
                },
              ],
            },
              ...
              fields: [
                {
                  ...
                  name: "name",
                  widget: "string",
                  hint: "The full name of the team member",
                  required: true,
                },
                {
                  label: "Job Title",
                  name: "title",
                  widget: "string",
                  hint: "The Job title of the team member (without a company attribution)",
                  required: true,
                },
                {
                  label: "Company",
                  name: "company",
                  widget: "string",
                  hint: "The company that this team member works for.",
                  required: true,
                },
                {
                  label: "Image",
                  name: "image",
                  widget: "image",
                  hint: "The profile image for this team member.",
                  required: false,
                },
                {
                  label: "Bio",
                  name: "bio",
                  widget: "text",
                  hint: "The bio of the team member",
                  required: false,
                },
                {
                  label: "Teams",
                  ...
                  widget: "select",
                  multiple: true,
                  hint: "The teams that this person is a part of.",
                  options: [
              ...
              fields: [
                {
                  ...
                  name: "Project Contact Information",
                  widget: "object",
                  fields: [
                    {
                      label: "Meetings",
    ...
    },
    {
      ...
      files: [
              ...
              fields: [
                {
                  ...
                  name: "title",
                  widget: "string",
                  hint: "The name of the Engineering vertical",
                  required: true,
                },
                {
                  label: "Cover Image",
                  name: "cover_image",
                  widget: "image",
                  hint: "The video poster image that is displayed before the video is watched.",
                  required: true,
                },
                {
                  label: "OGV URL",
                  name: "ogv",
                  widget: "string",
                  hint: "The URL to the OGV video file.",
                },
                {
                  label: "WEBM URL",
                  name: "webm",
                  widget: "string",
                  hint: "The URL to the WEBM video file.",
                },
                {
                  label: "MP4 URL",
                  name: "mp4",
                  widget: "string",
                  hint: "The URL to the MP4 video file.",
                },
              ],
            },
          ],
          ...
          fields: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  name: "context_image",
                  widget: "image",
                  hint: "An image that provides context to this vertical/group. Used for background images etc.",
                  required: true,
                },
                {
                  label: "Icon",
                  ...
                  fields: [
                    ...
                    },
                    {
                      ...
                      widget: "image",
                      name: "svg",
                      hint: "The SVG version of the icon.",
                      required: true,
                    },
                  ],
                },
                {
                  ...
                  name: "url",
                  widget: "string",
                  hint: "The URL relevant to this engineering vertical/group.",
                },
              ],
            },
          ],
              ...
              fields: [
                {
                  ...
                  name: "title",
                  widget: "string",
                  hint: "The title of the external news post.",
                  required: false,
                },
                {
                  label: "Link",
                  name: "url",
                  widget: "string",
                  hint: "The url to the external news post.",
                  required: false,
                },
                {
                  label: "Related Linaro Members",
                  name: "related_members",
                  widget: "list",
                  hint: "A comma separated list of any members that this post related to. I.e HiSilicon",
                  required: false,
                },
                {
                  ...
                  name: "image",
                  widget: "image",
                  hint: "Please select a featured image for this external news post.",
                  required: false,
                },
                {
                  label: "Description",
                  name: "description",
                  widget: "text",
                  hint: "Enter a short description for this external news post.",
                  required: false,
                },
                {
                  label: "Related Linaro Static Site",
                  name: "site",
                  widget: "select",
                  hint: "Please select the site that this should appear on.",
                  options: [
                    "linaro.org",
                    "96boards.org",
                    "mlplatform.org",
                ...
                },
                {
                  ...
                  name: "category",
                  widget: "select",
                  hint: "Please select the category which this external post falls into.",
                  options: ["Membership", "Tech Review", "Press Release"],
                  required: false,
                },
                {
                  label: "Publish Date",
              ...
              fields: [
                {
                  ...
                  name: "name",
                  widget: "string",
                  hint: "The name of the project that we contribute to.",
                  required: false,
                },
                {
                  ...
                  name: "url",
                  widget: "string",
                  hint: "URL of the project we contribute to.",
                  required: false,
                },
                {
                  label: "Project Logo",
        ...
        {
          label: "Timeline",
          name: "linaro_about_timeline_items",
              ...
              fields: [
                {
                  ...
                  name: "name",
                  widget: "string",
                  hint: "The 4 digit year of your timeline carousel item.",
                  required: false,
                },
                {
                  label: "Entries",
        ...
        {
          label: "Membership Testimonials",
          name: "membership_testimonials",
          file: "_data/membership_testimonials.yml",
          fields: [
            {
              label: "Testimonials",
              name: "items",
        ...
        },
        {
          ...
          name: "internship_testimonials",
          file: "_data/internship_testimonials.yml",
          fields: [
            {
              label: "Testimonials",
              name: "items",
              ...
              fields: [
                ...
                },
                {
                  ...
                  name: "title",
                  widget: "string",
                  hint: "Internship title i.e Entry Level, Engineer",
                },
                {
    ...
    },
    {
      ...
      create: true,
      description:
        "This collection allows you to add/edit/delete pages on Linaro.org.\n",
      slug: "{{permalink}}",
      fields: [...pageMetaFields, { ...header }, { ...flowFrontMatter }],
    },
    {
      label: "Themes",
      name: "themes",
      ...
      create: true,
      description:
        "This collection allows you to add/edit/delete themes on Linaro.org.\n",
      slug: "{{permalink}}",
      fields: [
        ...pageMetaFields,
        {
          ...
          name: "sub_theme",
          widget: "boolean",
          hint: "Whether this theme is a sub theme.",
          required: true,
        },
        {
          label: "Icon",
        ...
        {
          label: "Video Resources Link",
          name: "video_resources_link",
          widget: "string",
          required: false,
        },
        { ...header },
    ...
    },
    {
      ...
      create: true,
      description:
        "Manage the individual Developer Services pages. To edit the landing page visit the Pages section of NetlifyCMS.\n",
      slug: "{{permalink}}",
      fields: [
        ...pageMetaFields,
        {
    ...
    },
    {
      ...
      description:
        "This collection allows you to add/edit/delete news posts on the Linaro.org. Please upload/select a high resolution image for the featured image.\n",
      editor: {
        preview: true,
      },
      fields: [...postFields],
    },
    {
      name: "blog",
      label: "Blog Posts",
      folder: "_posts/current/blog",
      create: true,
      sort: "date:desc",
      slug: "{{year}}-{{month}}-{{day}}-{{slug}}",
      preview_path: "/blog/{{title}}/",
      description:
        "This collection allows you to add/edit/delete blog posts on the Linaro.org. Please upload/select a high resolution image for the featured image.\n",
      editor: {
        preview: true,
      },
      fields: [...postFields],
    },
    {
      name: "older_posts",
      label: "Older Posts",
      folder: "_posts/previous",
      create: true,
      sort: "date:desc",
      slug: "{{year}}-{{month}}-{{day}}-{{slug}}",
      preview_path: "/blog/{{title}}/",
      description:
        "This collection allows you to add/edit/delete older posts on the Linaro.org. This is predominantly used for fixing broken links.\n",
      editor: {
        preview: true,
      },
      fields: [...postFields],
    },
    {
      ...
      sort: "date:desc",
      slug: "{{year}}-{{month}}-{{day}}-{{slug}}",
      preview_path: "/events/{{title}}/",
      description:
        "This section allows you to add/edit/delete an event that is listed at linaro.org/events/\n",
      editor: {
        preview: true,
      },
      fields: [
        ...
        },
        {
          ...
          name: "event",
          widget: "string",
          hint: "Add a unique id to reference in event resources. I.e third-edge-computing-forum",
        },
        {
          label: "Event URL",
          name: "event_url",
          widget: "string",
          hint: "Provide a link to the event website.",
          required: false,
        },
        {
          ...
          name: "description",
          widget: "text",
          hint: "Description of your event.",
        },
        {
          label: "Coming soon",
          name: "coming_soon",
          widget: "boolean",
          hint: "Set the status of this event to 'Coming soon'.",
          required: false,
        },
        {
          label: "Visual Date Override",
          name: "visual_date",
          widget: "text",
          hint: "Overrides the visual date displayed.",
          required: false,
        },
        {
        ...
        },
        {
          ...
          hint: "The type of event that we are listing.",
        },
        {
          label: "Body",
          name: "body",
          widget: "markdown",
          hint: "Any additional information for your event.",
          required: false,
        },
      ],
    },
    {
      ...
      folder: "_posts/events/resources",
      create: true,
      sort: "date:desc",
      slug: "{{year}}-{{month}}-{{day}}-{{slug}}",
      preview_path: "/events/{{title}}/",
      description:
        "This section allows you to add/edit/delete an event resource for an event based on the uid set for the event.\n",
      editor: {
        preview: true,
      },
      fields: [
        ...
        },
        {
          ...
          dispalyFields: ["title"],
          valueField: "event",
          hint: "Add the unique id of an event (set on an event). I.e third-edge-computing-forum",
        },
        {
          label: "Resource Date",
          name: "date",
        ...
        },
        {
          ...
          name: "image",
          widget: "image",
          hint: "Add an image for the resource. I.e screen cap of the youtube video",
        },
        {
          label: "Resource Youtube Video URL",
          name: "youtube_video_url",
          widget: "string",
          hint: "Provide a youtube video of the event resource.",
          required: false,
        },
        {
          label: "Resource Presentation URL",
          name: "amazon_s3_presentation_url",
          widget: "string",
          hint: "Add a link to the resource presentation. Url must be to a PDF of the slides.",
          required: false,
        },
        {
          ...
          fields: [
            {
              ...
              widget: "string",
              name: "name",
              hint: "The name of the speaker",
            },
            {
              label: "Bio",
              widget: "text",
              name: "biography",
              hint: "The bio of the speaker",
            },
            {
              label: "Job Title",
              widget: "string",
              name: "job-title",
              hint: "Job title of the speaker",
            },
            {
              label: "Company",
              widget: "string",
              name: "company",
              hint: "Thes speaker's company.",
            },
          ],
        },
        {
          label: "Event Abstract/Details",
          name: "body",
          widget: "markdown",
          hint: "Any additional information for your event resource/session.",
        },
      ],
    },
    {
      ...
      description:
        "This collection allows you to add/edit/delete authors. These are dynamically pulled in when writing posts. When deleting authors the change is made directly to the develop branch (which causes a www.linaro.org build).\n",
      editor: {
        preview: false,
      },
      fields: [
...
doc.contents = JSON.parse(JSON.stringify(config));
fs.writeFileSync("./admin/config.yml", doc.toString(), "utf-8");
console.log("/admin/config.yml file has been written successfully...");
