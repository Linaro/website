...
{% include image.html name="Guy-Berruyer1.jpg" class="linaro-profile-image" alt="Guy Berruyer Profile Photo"%}
...
{% include image.html name="Ian-Ferguson.jpg" class="linaro-profile-image" alt="Ian Ferguson Profile Photo"%}
...
{% include image.html name="Jason-Pettit.jpg" class="linaro-profile-image" alt="Jason Pettit Profile Photo"%}
...
{% include image.html name="Eric-Finco.jpg" class="linaro-profile-image" alt="Eric Finco Profile Photo"%}
