...
A: Look at the GlobalPlatform Internal Core API specification. We have full support for that in OP-TEE ([https://globalplatform.org/](https://globalplatform.org/))
