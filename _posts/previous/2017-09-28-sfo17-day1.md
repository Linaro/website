...
slug: sfo17-day1
title:
  Linaro Connect SFO17 kicks off with new 96Boards products, members and technology
  demonstrations
wordpress_id: 12813
category: blog
---

The 22nd Linaro Connect began on Monday 25 September with the [keynote](https://connect.linaro.org/resources/sfo17/sfo17-100k1/) given by Linaro CEO George Grey. As usual, Grey packed the opening hour with an update on new Linaro members, key engineering achievements, a look at areas of future interest and a series of demonstrations pulling together various aspects of Linaro’s current activities.

New members this time included [Xilinx joining the Linaro Iot and Embedded (LITE) Group](/news/xilinx-joins-linaro-iot-embedded-group/), Kylin joining the Linaro Enterprise Group ([LEG](/engineering/datacenter-and-cloud/)) and NXP extending their existing LITE membership to also participate in the Linaro Digital Home Group ([LHG](/engineering/)).
...
{% include image.html path="/assets/images/blog/arrow-sponsor-linaro.jpg" alt="Arrow Sponsor Linaro Connect SFO17" %}

Arrow Sponsor

{% include image.html path="/assets/images/blog/hoperun-sponsor.jpg" alt="Arrow Sponsor Linaro Connect SFO17" %}
...
{% include image.html path="/assets/images/blog/socionext-sfo17-sponsor.jpg" alt="Socionext SFO17 Sponsor" %}
Socionext

A series of demonstrations showing the microPlatforms developed by the Linaro Technologies group followed. These included fully open source Zephyr on Cortex-M and Linux on Cortex-A.
...
{% include image.html path="/assets/images/blog/sfo17-group-photo.jpg" alt="SFO17 Group Photo" url="https://www.flickr.com/photos/linaroorg/37057590300/" %}
