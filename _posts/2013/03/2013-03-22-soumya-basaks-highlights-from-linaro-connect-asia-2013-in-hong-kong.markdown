...
Linaro [announced](/news/networking-leaders-collaborate-to-maximize-choice-performance-and-power-efficiency/en) its newest group-- the [Linaro Networking Group](/engineering/lng) (LNG)-- which builds on the model that was created with [Linaro Enterprise Group](/groups/leg/) (LEG) and brings together members with several new companies.
