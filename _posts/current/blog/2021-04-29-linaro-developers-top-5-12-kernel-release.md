...
{% include image.html path="/assets/images/content/kernel-5.12-most-active-bug-reporters.png" alt="List of 5.12 Most Active Bug Reporters" %}

{% include image.html path="/assets/images/content/test-and-review-credits-in-5.12-kernel.png" alt="List of 5.12 Test and Review Credits" %}
