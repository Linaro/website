...
description: "Libcamera is an open source friendly camera stack and userspace
  ...
  longstanding pain point in the Linux ecosystem, we decided to contribute to
  accelerating Qcam so we can have a much more performant demo of libcamera on
