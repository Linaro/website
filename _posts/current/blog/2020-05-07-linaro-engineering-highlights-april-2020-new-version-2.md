...
* Not mentioned in the article but two other key statistics  
  ...
  * Naresh Kamboju ranked at #10 for reported-by <br/> <br/>     **Most Active 5.6 Employers**

| \| By Changesets    |     |      | By Lines Changed   |       |       |     | Intel | 1694 | 13.4% | Intel | 78083 | 11.5% |
| ------------------- | --- | ---- | ------------------ | ----- | ----- | --- | ----- | ---- | ----- | ----- | ----- | ----- |
...
{:.table.my-5} <br/> **Most Active 5.6 Developers**          

| \| By Changesets    |     |      | By Lines Changed    |       |      |     | Takashi Iwai | 406 | 3.2% | Kalle Valo | 48483 | 7.2% |
| ------------------- | --- | ---- | ------------------- | ----- | ---- | --- | ------------ | --- | ---- | ---------- | ----- | ---- |
