...
{% include image.html name="DB845cblog3.png" class="medium-inline" alt="The Alt text for your image" %}
...
{% include image.html name="DB845cblog4.png" class="medium-inline right" alt="The Alt text for your image" %}
