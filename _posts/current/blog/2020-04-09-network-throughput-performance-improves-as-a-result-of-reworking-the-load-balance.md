...
From this observation, the idea of a full rework of the load balance began to emerge. The aim of reworking the load balance has been to:  Clean up the code and remove old heuristics which are meaningless.
...
hackbench -l (2560/#grp) -g #grp  1 groups      1.579 +/-29.16%       1.410 +/-13.46% (+10.70%)
...
hackbench -l (256000/#grp) -g #grp   1 groups    15.305 +/-1.50%       14.001 +/-1.99%   (+8.52%)
...
dbench   1 groups   328.176 +/-0.29%      330.217 +/-0.32%   (+0.62%)
