...
<hr>
    <div class="col-sm-9 session-info">
        ...
        <strong>Speaker Name / Company</strong>
        <p class="speaker-name-company">
            Yutaka Ishikawa, RIKEN AICS
        </p>
        
        <strong>Talk Abstract</strong>
...
<hr>
    <div class="col-sm-9 session-info">
        ...
        <strong>Speaker Name / Company</strong>
        <p class="speaker-name-company">
            Richard Sandiford, Florian Hahn (Arm), ARM
        </p>
...
<hr>
    <div class="col-sm-9 session-info">
        ...
        <strong>Speaker Name / Company</strong>
        <p class="speaker-name-company">
            Masaki Arai, Fujitsu Laboratories Ltd.
        </p>
    ...
    <div class="col-sm-3 speaker-info">
        ...
        <strong>Speaker Contact Email</strong>
        <p>
...
<hr>
    <div class="col-sm-9 session-info">
        ...
        <strong>Speaker Name / Company</strong>
        <p class="speaker-name-company">
            Tobias Grosser, Scalable Parallel Computing Laboratory (SPCL)
        </p>
...
<hr>
    <div class="col-sm-9 session-info">
        ...
        <strong>Speaker Name / Company</strong>
        <p class="speaker-name-company">
            Katsuki Fujisawa, The Institute of Mathematics for Industry, Kyushu University & The Artificial Intelligence Research Center, Advanced Industrial Science and Technology)
        </p>
...
<hr>
    <div class="col-sm-9 session-info">
        ...
        <strong>Speaker Name / Company</strong>
        <p class="speaker-name-company">
            Hiroshi Nakashima, Kyoto University / RIKEN AICS
        </p>
