...
To learn more about the Linaro Networking Group (LNG) please visit:  [ http://www.linaro.org/projects/networking](/projects/networking/) and for Data Plane Programming API: [www.OpenDataPlane.org](http://www.opendataplane.org/)
