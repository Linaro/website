...
The Infrastructure Team is supporting the ongoing effort for Linaro as a whole. The reworking of the Linaro roadmap under [http://status.linaro.org/11.12/roadmap-2011Q4.html ](/about/)now includes artistic graphs that visualize work items progress for roadmap
