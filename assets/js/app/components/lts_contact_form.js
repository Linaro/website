$(document).ready(function () {
  ...
  if ($("#lts_contact_form_modal").length > 0) {
    lts_contact_form.onsubmit = (e) => {
      e.preventDefault();
      ...
      if (message !== "") {
        ...
        var data = new FormData(lts_contact_form);
  ...
  if ($(".submitButtonLtsForm").length > 0) {
    $(".submitButtonLtsForm").on("click", () => {
      $("#lts_contact_form_modal").modal("toggle");
    });
  }
